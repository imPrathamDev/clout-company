...
function SocialPlatforms() {
  return (
    <section className="relative flex min-h-0 flex-1 flex-col justify-center h-[75vh] md:min-h-svh pt-[100px] min-[1000px]:pb-[220px] pb-[160px] min-[767px]:pb-[100px] overflow-hidden">
      <Image
      ...
      <div className="w-full h-full absolute top-0 left-0">
        <div className="mx-auto max-w-[900px] max-[1000px]:w-full shrink-0 px-6 mt-[100px]">
          <h2
            style={{
              textShadow:
                "0 0 3px rgba(0, 0, 0, 0.08), 0 0.5px 0.5px rgba(0, 0, 0, 0.12)",
            }}
            className="text-background leading-[120%] m-0 mx-auto text-center text-[26px] min-[768px]:text-[32px] min-[1000px]:text-[40px] max-w-[27ch]"
          >
